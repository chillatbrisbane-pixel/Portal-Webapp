...
const TECH_CONFIGS: TechConfig[] = [
  ...
  { key: 'controlSystem', label: 'Control System', icon: '🎛️', deviceType: 'control-processor', defaultBrands: ['Control4', 'Crestron', 'Savant'], defaultVlan: 1 },
  { key: 'touchPanels', label: 'Touch Panels', icon: '📱', deviceType: 'touch-panel', defaultBrands: ['Control4', 'Crestron'], defaultVlan: 1 },
